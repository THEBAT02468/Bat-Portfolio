...
(function () {
  var T = {
    es: {
      ...
      'index.fp.card1.title': 'Clothes-Bot',
      'index.fp.card1.desc':  'Bot de clothing para WhatsApp.',
      'index.fp.card2.title': 'LegacyApp',
      'index.fp.card2.desc':  'App fitness del gimnasio Legacy para organizar rutinas, dietas e instructores.',
      'index.fp.card3.title': 'Máquina Gotham',
      'index.fp.card3.desc':  'CTF en Dockerlabs: JWT, command injection, password reuse, sudo misconfig.',
    ...
    en: {
      ...
      'index.fp.h2':       'WORK',
      'index.fp.card1.title': 'Clothes-Bot',
      'index.fp.card1.desc':  'WhatsApp clothing bot.',
      'index.fp.card2.title': 'LegacyApp',
      'index.fp.card2.desc':  'Legacy gym fitness app to manage routines, diets and instructors.',
      'index.fp.card3.title': 'Gotham Machine',
      'index.fp.card3.desc':  'Dockerlabs CTF: JWT, command injection, password reuse, sudo misconfig.',
